...
if __name__ == '__main__':
     ...
     #    -> 매 상황, 방문하지 않은 start 중 최소값을 골르는 특정 과정 반복
     ...
     #   ****인접node들 중 [비용이 작아, 꺼낸 start] -> 꺼낸node까지의 거리는 이미 fix된 최단경로
     ...
     # => 참고로, [아직 queue에서 나오지 않은 이전level의  start]로의 경로는
